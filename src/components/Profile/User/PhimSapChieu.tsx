...
export const PhimSapChieu = ({ movies }: PhimDaXemProps) => {
 return (
    <div className="text-white backdrop-blur-3xl rounded-2xl bg-white/5 p-4 overflow-x-auto">
      <h1 className='text-white text-shadow-2xs font-bold text-2xl mb-3'>Phim Sắp Chiếu</h1>
