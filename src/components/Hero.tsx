...
const Hero = () => {
  ...
  return (
    <div
      className="relative w-full h-[100vh] bg-cover bg-center transition-all duration-500"
      style={{ backgroundImage: `url(${backgroundImage})` }}
    >
      <div className="absolute inset-0 bg-gradient-to-t from-black via-black/60 to-transparent z-0" />

      {/* Nội dung trái */}
      <div className="absolute md:top-1/4 top-120 md:left-20  z-10  md:w-[30%]  text-white space-y-2 md:space-y-6 backdrop-blur-md bg-black/40 p-8 rounded-2xl shadow-2xl">
